module PayrollNotification
  class AnnualDeterminationHandler
    ...
    def execute
      ...
      return if overlaps_with_ad_hoc_revision? || refresh_existing_notification(monthly_standard_unchanged)
      return if !monthly_standard_unchanged || !annual_determination_pending?
    ...
    def refresh_existing_notification(monthly_standard_unchanged)
    ...
    def annual_determination_pending?
      base_year = @ym /100
