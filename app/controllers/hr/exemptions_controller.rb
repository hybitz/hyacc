class Hr::ExemptionsController < Base::HyaccController
  ...
  def exempiton_params
    permitted = [:employee_id, :yyyy, :small_scale_mutual_aid,
      ...
      :dependents, :disabled_persons, :basic, :special_tax_for_specified_family,
      ...
      :dependent_family_members_attributes => [:id, :exemption_type, :name, :kana, :my_number, :live_in, :_destroy, :family_sub_type, :non_resident_code]
    ]
