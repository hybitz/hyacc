module HyaccConst
  ...
  SUB_ACCOUNT_TYPES = {
    ...
    SUB_ACCOUNT_TYPE_GENERAL_AND_SPECIFIC_ACCOUNT = 11 => '一般・特定口座',
  ...
  # 預り金控除区分
  TAX_DEDUCTION_TYPES = {
    TAX_DEDUCTION_TYPE_INCOME_TAX = '100' => '源泉所得税',
    TAX_DEDUCTION_TYPE_HEALTH_INSURANCE = '200' => '健康保険料',
    TAX_DEDUCTION_TYPE_WELFARE_PENSION = '300' => '厚生年金',
    TAX_DEDUCTION_TYPE_INHABITANT_TAX = '400' => '住民税',
    TAX_DEDUCTION_TYPE_EMPLOYMENT_INSURANCE = '500' => '雇用保険料'
  }
  ...
  ACCOUNT_CODE_SUSPENSE_RECEIPT = '3310' # 仮受金
  ACCOUNT_CODE_SUSPENSE_RECEIPT_EMPLOYEE = '3311' # 仮受金（従業員）
  ...
  ACCOUNT_CODE_DONATION = '8741' # 寄付金
  ...
  ACCOUNT_CODE_TEMP_PAY_CORPORATE_TAXES = '1885' # 仮払法人税等
  ...
  ACCOUNT_CODE_EXECUTIVE_BONUS = '8323' # 役員賞与
  ...
  SUB_ACCOUNT_CODE_BUSINESS_TAX = '100' # 法人事業税
  SUB_ACCOUNT_CODE_DONATION_DESIGNATED = '100'  # 指定寄附金等
  SUB_ACCOUNT_CODE_DONATION_OTHERS = '200' # その他
