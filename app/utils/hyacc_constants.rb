module HyaccConstants
  ...
  SUB_ACCOUNT_CODE_EMPLOYEES_INSURANCE_OF_ADVANCE_MONEY = '500' # 雇用保険料（立替金）
  ...
  SUB_ACCOUNT_CODE_EMPLOYEES_INSURANCE_OF_DEPOSITS_RECEIVED = '500' # 雇用保険料（預り金）
  ...
  SUB_ACCOUNT_CODE_EMPLOYEES_INSURANCE_OF_LEGAL_WELFARE = '500' # 雇用保険料（法定福利費）
