...
module HyaccConstants
  ...
  # 消費税区分
  TAX_TYPES = {
    TAX_TYPE_NONTAXABLE = Tax::TAX_TYPE_NONTAXABLE => Tax::TAX_TYPES[Tax::TAX_TYPE_NONTAXABLE], # 1
    TAX_TYPE_INCLUSIVE = Tax::TAX_TYPE_INCLUSIVE => Tax::TAX_TYPES[Tax::TAX_TYPE_INCLUSIVE],    # 2
    TAX_TYPE_EXCLUSIVE = Tax::TAX_TYPE_EXCLUSIVE => Tax::TAX_TYPES[Tax::TAX_TYPE_EXCLUSIVE],    # 3
  }
