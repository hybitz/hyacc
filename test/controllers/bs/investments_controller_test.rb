...
class Bs::InvestmentsControllerTest < ActionController::TestCase
  ...
  def test_削除で3階層が連鎖して物理削除される
    post :create, xhr: true, params: {
      investment: { yyyymmdd: '2016-03-27', bank_account_id: bank_account.id, customer_id: '1', securities_transaction_type: SECURITIES_TRANSACTION_TYPE_BUYING, for_what: '1', shares: '20', trading_value: '100000', charges: '0' }
    }
  ...
  def test_売却でも自動仕訳を作成できること
    assert_difference(['Investment.count', 'Journal.count']) do
      post :create, xhr: true, params: {
        investment: { yyyymmdd: '2016-03-27', bank_account_id: bank_account.id, customer_id: '1', securities_transaction_type: SECURITIES_TRANSACTION_TYPE_SELLING, for_what: '1', shares: '20', trading_value: '100000', charges: '0', gains: '0' }
      }
    end
    assert_response :success
    investment = Investment.order(:id).last
  ...
  def test_手数料が0円でも追加と更新ができること
    params = { yyyymmdd: '2016-03-27', bank_account_id: bank_account.id, customer_id: '1', securities_transaction_type: SECURITIES_TRANSACTION_TYPE_BUYING, for_what: '1', shares: '20', trading_value: '100000', charges: '0' }
