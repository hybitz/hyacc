module HyaccErrors
  ...
  ERR_BANK_DISABLE_LINKED = "金融機関は既に関連口座が存在するため、無効にできません。"
  ERR_BANK_LINKED = "金融機関は既に関連口座が存在するため、削除できません。"
  ERR_BANK_OFFICE_DISABLE_LINKED = "は既に関連口座が存在するため、無効にできません。"
  ERR_BANK_OFFICE_LINKED = "は既に関連口座が存在するため、削除できません。"
