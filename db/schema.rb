...
ActiveRecord::Schema.define(:version => 20140216064143) do
  ...
  add_index "account_controls", ["account_id"], :name => "index_account_controls_on_account_id", :unique => true
  ...
  add_index "assets", ["code"], :name => "index_assets_on_code", :unique => true
  ...
  add_index "bank_accounts", ["name"], :name => "index_bank_accounts_on_name", :unique => true
  ...
  add_index "business_types", ["name"], :name => "index_bisiness_types_on_name", :unique => true
  ...
  add_index "customer_names", ["customer_id"], :name => "index_customer_names_on_customer_id"
  ...
  add_index "depreciation_rates", ["durable_years"], :name => "index_depreciation_rates_on_durable_years", :unique => true
  ...
  add_index "fiscal_years", ["company_id", "fiscal_year"], :name => "index_fiscal_yeras_on_company_id_and_fiscal_year", :unique => true
  ...
  add_index "housework_details", ["housework_id", "account_id", "sub_account_id"], :name => "index_housework_details_as_unique_key", :unique => true
  add_index "housework_details", ["housework_id", "account_id"], :name => "index_housework_details_on_housework_id_and_account_id", :unique => true
  ...
  add_index "journal_details", ["journal_header_id", "detail_no"], :name => "journal_details_journal_header_id_and_detail_no_index", :unique => true
  ...
  create_table "journal_headers", :force => true do |t|
    ...
    t.integer  "company_id",                                          :null => false
    t.integer  "approval_status",         :limit => 1, :default => 0, :null => false
  end

  add_index "journal_headers", ["transfer_from_detail_id"], :name => "index_journal_headers_transfer_from_detail_id"
  add_index "journal_headers", ["ym"], :name => "index_journal_headers_on_ym"
  ...
  add_index "payrolls", ["pay_journal_header_id"], :name => "fk_payrolls_pay_journal_header_id"
  add_index "payrolls", ["payroll_journal_header_id"], :name => "fk_payrolls_payroll_journal_header_id"
  ...
  add_index "sequences", ["name", "section"], :name => "index_sequences_on_name_and_section", :unique => true
  ...
  add_index "simple_slip_templates", ["remarks"], :name => "index_simple_slip_templates_on_remarks"
