module HyaccConst
  ...
  # 代表者／代表者の家族区分
  REPRESENTATIVE_OR_FAMILY_TYPES = {
    REPRESENTATIVE_OR_FAMILY_TYPE_REPRESENTATIVE = 1 => '代表者',
    REPRESENTATIVE_OR_FAMILY_TYPE_FAMILY = 2 => '代表者の家族',
  }
  ...
  TAX_DEDUCTION_TYPES = {
    ...
    TAX_DEDUCTION_TYPE_CHILD_AND_CHILDCARE_SUPPORT = '600' => '子ども・子育て支援金'
  }
  ...
  ACCOUNT_CODE_TANGIBLE_FIXED_ASSETS = '2110' # 有形固定資産
  ACCOUNT_CODE_TOOLS_AND_EQUIPMENT = '2161' # 工具器具備品
  ...
  ACCOUNT_CODE_INTEREST_RECEIVED_LOAN_EMPLOYEE = '4226' # 受取利息（貸付・従業員）
  ACCOUNT_CODE_INTEREST_RECEIVED_LOAN_BRANCH = '4227' # 受取利息（貸付・部門）
  ACCOUNT_CODE_INTEREST_RECEIVED_LOAN_CUSTOMER = '4228' # 受取利息（貸付・取引先）
  ...
  ACCOUNT_CODE_EXECUTIVE_RETIREMENT = '8324' # 役員退職金
  ...
  # 寄付先マスタで種別(kind)を持つ寄付金補助科目コード一覧
  DONATION_RECIPIENT_SUB_ACCOUNT_CODES = [
    SUB_ACCOUNT_CODE_DONATION_DESIGNATED,
    SUB_ACCOUNT_CODE_DONATION_PUBLIC_INTEREST,
    SUB_ACCOUNT_CODE_DONATION_NON_CERTIFIED_TRUST
  ]
