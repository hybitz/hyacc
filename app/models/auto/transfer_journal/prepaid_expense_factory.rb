# coding: UTF-8
#
# $Id: prepaid_expense_factory.rb 3064 2013-06-21 03:14:30Z ichy $
# Product: hyacc
...
module Auto::TransferJournal
  ...
  class PrepaidExpenseFactory < Auto::AutoJournalFactory
    ...
    def make_journals()
      ...
      auto_jd[0].dc_type = opposite_dc_type( @src_jd.dc_type )
      ...
      auto_jd[1].account_id = Account.get_by_code( ACCOUNT_CODE_PREPAID_EXPENSE ).id
