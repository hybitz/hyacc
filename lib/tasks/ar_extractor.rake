...
namespace :db do
  namespace :fixtures do
    ...
    task :extract => :environment do
      ...
      tables = {}
      table = []
      open("#{Rails.root}/db/schema.rb") do |file|
    ...
    task :convert => :environment do
      ...
      CONFIG_FILE = "#{Rails.root}/config/tables.yml"
...
def exist_module?
  ...
  File.exist?("#{Rails.root}/lib/#{mod.underscore}.rb") ? mod.constantize : false
end
