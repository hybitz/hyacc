module HyaccConst
  ...
  ACCOUNT_CODE_SHORT_TERM_LOAN_SHAREHOLDER = '1704' # 短期貸付金（株主）
  ...
  ACCOUNT_CODE_INVESTMENTS_AND_OTHER_ASSETS = '2130' # 投資その他の資産
  ...
  ACCOUNT_CODE_LONG_TERM_LOAN_SHAREHOLDER = '2704' # 長期貸付金（株主）
