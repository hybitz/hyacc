class Mm::CompaniesController < Base::HyaccController
  ...
  def company_params
    permitted = [
      :logo, :admin_email, :business_type_id, :day_of_payday, :month_of_payday, :enterprise_number, :labor_insurance_number, :social_insurance_number, :employment_insurance_type
    ]
